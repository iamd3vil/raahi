...
# Requires: just, latest stable cargo/rustc, pnpm ≥9 (or npm), cmake + Go + Perl + C/C++ toolchain
...
doctor:
    ...
    set -euo pipefail
    echo "== toolchain =="
    printf "%-12s " "rustc:"; rustc --version 2>&1 || echo "MISSING (install latest stable)"
